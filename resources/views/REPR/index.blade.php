                ...
                <div class="card">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            @if (Auth::user()->role == 'Medecin')
                                <div class="pull-right">
                                    <a class="btn btn-success" href="{{ route('Repr.create') }}"> Ajouter Prélèvement</a>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h5>Demandes du Jour/<a href="{{ route('Repr.index') }}">Reprélèvements</a></h5>
                                </div>
                                <div class="col-sm-6">
                                    <form class="search-box" method="GET" action="{{ route('Repr.search') }}">
                                    ...
                                    <tr>
                                        ...
                                        @if (Auth::user()->role == 'Medecin')
                                            <td>
                                                ...
                                                <a href="{{ route('Repr.edit', $pre->id) }}" class="text-success"
                                                    title="Edit" data-toggle="tooltip"><i
                                                        id="edit"class="fa fa-edit"></i></a>
                                                <a href="{{ route('Repr.destroy', $pre->id) }}" class="delete"
