                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <form class="search-box" method="GET" action="{{ route('demandes.search_r') }}">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" >Type Bloc </th>
                                    <th class="text-center">Médecin Demandant</th>
                                    <th class="text-center">Date Demande</th>
                                    <th class="text-center">Nombre Recoupe</th>
                                    <th class="text-center">Degrée Réinclusion</th>
