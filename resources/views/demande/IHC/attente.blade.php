        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <a href="{{ route('IHC.create') }}" class="btn btn-outline-primary col-sm-4" role="button">Nouvelle Demande</a>
                    <a href="{{ route('IHC.valide') }}" class="btn btn-outline-success col-sm-4" role="button">Demandes Validées</a>
                    <a href="{{ route('IHC.attente') }}" class="btn btn-outline-danger col-sm-4" role="button">Demandes En Attente</a>
                   @else
                    <a href="{{ route('IHC.valide') }}" class="btn btn-outline-success col-sm-6" role="button">Demandes Validées</a>
                    <a href="{{ route('IHC.attente') }}" class="btn btn-outline-danger col-sm-6" role="button">Demandes En Attente</a>
                   @endif
                    </div>
            </div>
            <br>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <td><p class="font-weight-bold"> {{ $dem->Reference_Bloc ?? ' Reference introuvable' }}</p>
                        ...
                        <th>
                            @if ((Auth::user()->role != 'Medecin'))
                            <input type ="checkbox"  id="myDiv"  name="ids[]"  value="{{route('IHC.show', $dem->id)}}" class="checkboxclass1"  aria-hidden="false"  />
                            @endif
                        </th>
