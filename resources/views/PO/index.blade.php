...
@section('title', 'Piéces Opératoires')
                ...
                <div class="card">
                        ...
                        <div> </div>
                            @if (Auth::user()->role == 'Medecin')
                                <div class="pull-right">
                                    <a class="btn btn-success" href="{{ route('PO.create') }}">Ajouter Prélèvement</a>
                                </div>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h5>Demandes du Jour/<a href="{{ route('PO.index') }}">Piéces Opératoires</a></h4>
                                </div>
                                <div class="col-sm-6">
                                    <form class="search-box" method="GET" action="{{ route('PO.search') }}">
                                    ...
                                    <tr>
                                        ...
                                        @if (Auth::user()->role == 'Medecin')
                                            <td>
                                                ...
                                                <a href="{{ route('Prelevements.edit', $pre->id) }}" class="text-success"
                                                    title="Edit" data-toggle="tooltip"><i id="edit" class="fa fa-edit"></i></a>
                                                <a href="{{ route('Prelevements.destroy', $pre->id) }}" class="delete"
