...
@section('title', 'Edit Extemporanée')
        ...
        <form action="{{ route('Extp.update', $prelevement->id) }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @else
                    <textarea style="height:200px" name="Description" class="form-control" id="description"  readonly>{{ $prelevement->Description }}</textarea>
                    @endif
